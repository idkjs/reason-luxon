...
type t = Zone.t;
[@genType] [@bs.send] external isValid: t => bool = "isValid";

[@genType] [@bs.send] external name: t => string = "name";

[@genType] [@bs.send] external type_: t => string = "type";

[@genType] [@bs.send] external universal: t => bool = "universal";
